...
class TenantDatabase extends IHiveManager<TBLTenant> {
  TenantDatabase() : super();

  ValueListenable<Box<TBLTenant>> get boxListenable => box.listenable();

  //
  Future<bool> addNewTenant(TBLTenant tenant) async {
    //
