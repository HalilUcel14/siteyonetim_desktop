...
part of 'tbl_owner.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class TBLOwnerAdapter extends TypeAdapter<TBLOwner> {
  @override
  final int typeId = 6;

  @override
  TBLOwner read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, TBLOwner obj) {
    writer
      ..writeByte(12)
      ..writeByte(10)
      ..write(obj.userUid)
