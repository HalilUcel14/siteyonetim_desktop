...
part 'tbl_incomes.g.dart';

@HiveType(typeId: HiveTypes.incomes)
final class TBLIncomes extends BaseDBModel<TBLIncomes> {
  @HiveField(10)
  ...
  @override
  TBLIncomes fromJson(Map<String, dynamic> json) {
    return TBLIncomes(
      uid: json['uid'],
  ...
  factory TBLIncomes.fromJson(Map<String, dynamic> json) {
    return TBLIncomes(
      uid: json['uid'],
      userUid: json['userUid'],
      expenseTypeUid: json['expenseTypeUid'],
